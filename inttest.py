...
for looptype in looptypes:
    ...
    for i_ori, ori in enumerate(orientations):
        ...
        print rec, amplitudes[10,1]-rec, amplitudes[10,1]/rec
    ...
    ax.plot(qR_array/R, intensities1*(qR_array/R)**4/R**2, color='g', ls=linestyle)
...
for looptype in looptypes:
    ...
    ax.plot(qR_array/R, intensities1*(qR_array/R)**4/R**2, color='m', ls=linestyle)
