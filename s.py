'''
Script to calculate s(r) vector
The output is a n*6 table; each line is [r/R, th, z/R, sx, sy, sz]
'''
import os, sys
import numpy as np
import csv
...
sample = 'Al'
do_save = False # check the range before changing this to True!!
